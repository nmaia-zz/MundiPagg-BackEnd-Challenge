...
namespace Project.WebApi.Models.ElasticSearch
{
    public class PersonRegisterElasticSearchModel
    {
    ...
    public class PersonEditionElasticSearchModel
    {
    ...
    public class PersonConsultationElasticSearchModel
    {
        public Guid Id { get; set; }
        public string FirstName { get; set; }
        public string LastName { get; set; }
